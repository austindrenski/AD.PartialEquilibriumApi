    ...
    public class Model5 : IModel
    {
        ...
        public DelimitedFilePath Data()
        {
            ...
            using (StreamWriter writer = new StreamWriter(csv))
            {
                ...
                writer.WriteLine("4,5,-1,1.0,0.50,0.025"); // ...D2
                writer.WriteLine("4,5,-1,1.0,0.50,0.050"); // ...D3
                writer.WriteLine("4,5,-1,1.0,0.50,0.000"); // .B1
                writer.WriteLine("4,5,-1,1.0,0.50,0.000"); // ..C2
                writer.WriteLine("4,5,-1,1.0,0.50,0.025"); // ...D4
                writer.WriteLine("4,5,-1,1.0,0.50,0.050"); // ...D5
                writer.WriteLine("4,5,-1,1.0,0.50,0.000"); // ..C3
                writer.WriteLine("4,5,-1,1.0,0.50,0.025"); // ...D6
